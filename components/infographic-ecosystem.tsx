...
export function InfographicEcosystem() {
  ...
  const DiagramContent = ({ fullscreen = false }: { fullscreen?: boolean }) => (
    <div className={`relative w-full h-full flex flex-col items-center justify-between p-6 bg-black/60 backdrop-blur-3xl border border-white/5 rounded-[40px] overflow-hidden ${fullscreen ? 'min-h-[90vh]' : 'aspect-[16/10]'}`}>
